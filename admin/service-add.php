...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        try {
            $stmt = $pdo->prepare("INSERT INTO services (name, image_url, display_order) VALUES (?, ?, ?)");
            $stmt->execute([$name, $image_url, $display_order]);
            $success = 'Hizmet başarıyla eklendi.';
            header("Refresh: 2; url=/yonetim/hizmetler");
...
<div class="page-header">
    <h1 class="page-title">Yeni Hizmet Ekle</h1>
