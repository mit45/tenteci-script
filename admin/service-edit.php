...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        try {
            $stmt = $pdo->prepare("UPDATE services SET name = ?, image_url = ?, display_order = ? WHERE id = ?");
...
<div class="page-header">
    ...
    <a href="/yonetim/hizmetler" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Geri Dön</a>
</div>
...
<div class="form-container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="number" name="display_order" class="form-control" value="<?php echo htmlspecialchars($service['display_order']); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="image_url_text" class="form-control" value="<?php echo (strpos($service['image_url'], 'http') === 0) ? htmlspecialchars($service['image_url']) : ''; ?>" placeholder="https://...">
        </div>
